...
function Details() {
    ...
    if (customer) {
        return (
            <>
               <Shared />
            <h1 className=" text-center mt-3">Details of {customer.firstname} {customer.lastname} 's account</h1>
             <div className="container">
                 <div className = "col d-flex justify-content-end mt-3">
                     <button  type = "button" className = "btn btn-primary" onClick = {() => navigate('/newAccount/' + id)}>create account</button>
                 </div>
